	...
	return (
		<main className="h-screen w-screen overflow-hidden bg-stone-950 text-stone-300">
			...
			<div className="flex h-full">
				...
				<div className={`flex-grow transition-all duration-300 ${showInformationPanel ? 'w-[70%]' : 'w-full'}`}>
					<MainMap
						className="h-full"
				...
				<Paper className="absolute right-8 top-20 z-50">
					<div className="inline-flex flex-row mb-4 border border-gray-400 rounded-md w-full">
						<Button
							className={`flex-1 flex justify-center items-center text-center p-2 rounded-md ${showFiscalia ? 'bg-white text-black' : 'bg-inherit text-white'}`}
