  ...
  return (
    <main className="w-screen h-screen g-neutral-800 overflow-hidden absolute inset-0 z-0">
      ...
      >
        ...
        <AreaSinCubrimientoDeSitioLayer isEnabled={showCubrimientoDeSitio} />
      ...
      {isMobile ? (
            ...
            <Sheet>
              ...
              <SheetContent side="bottom">
                <SheetHeader>
                  ...
                  <SheetDescription>
                    Aquí puedes modificar cuales capas son visibles en el mapa.
                  </SheetDescription>
        ...
        >
          <div className="text-stone-300">
            <p className="m-6">
              El mapa que se puede ver en esta página permite observar las
              ubicaciones dentro del Area Metropolitana de Monterrey donde hay
              una mayor incidencia de feminicidios.
            </p>

            <h2 className="font-semibold text-lg mb-1">Introducción</h2>
            <p className="pb-3">
              El feminicidio se define como el asesinato de una mujer por su
              genero. México se encuentra entre los países con mayores tasas de
              feminicidios. Dentro de está situación, el estado de Nuevo León
              presenta una de las tasas más elevadas a nivel nacional, siendo
              uno de los estados con mayor acontecimiento de este tipo de
              delito. Está es una crisis multifacética, la cual afecta a todas
              las personas viviendo en la entidad. Los efectos de un
              feminicidio no acaban con la víctima. Este es un fenómeno qué
              afecta a todas las personas cercanas, tanto a la víctima como a la
              comunidad. Por lo tanto, la organización de Futuro con Derechos
              busca apoyar a estas víctimas indirectas (NNA) por el delito de
              feminicidio. La organización busca brindar apoyo integral, con el
              objetivo de mitigar el impacto social y contribuir a un entorno
              más seguro y resiliente.
            </p>
            <p>
              Para apoyar a la causa, GeoStats entró en colaboración con Futuro
              con Derechos para apoyar en la generación de una fuente de datos
              geográfica qué ayude a determinar el número correcto de posibles
              víctimas indirectas por el delito de feminicidio en Nuevo León.
              Adicionalmente, se propone la definición de un modelo predictivo
              qué identifique las zonas del estado de Nuevo León qué sean más
              propensas a qué sucedan feminicidios.
            </p>
          </div>
        </ModalSheet>
      ) : (
        <>
          ...
          <aside className="absolute top-0 right-0 w-[400px] h-full bg-neutral-900 p-6 overflow-y-auto text-stone-300 z-20 shadow-lg">
            ...
            <p className="mb-3">
              El mapa que se puede ver en esta página permite observar las
              ubicaciones dentro del Área Metropolitana de Monterrey donde hay
              una mayor incidencia de feminicidios.
            </p>
