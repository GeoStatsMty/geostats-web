...
import { Building, LucideIcon, Newspaper, Hospital, MapPin, User, Search } from 'lucide-react'
...
const CATEGORY_ICONS: Record<FilterCategory, LucideIcon> = {
	Fiscalia: <Building/>,
	Periodico: <Newspaper/>,
					...
					>
						{selected && (
							<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M8 3L4 7L2 5" stroke="#362A2A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
							</svg>
						)}
					</div>
				</div>
